...
import (
	...
	externalversions "github.com/n3wscott/gateway/pkg/client/informers/externalversions"
	client "github.com/n3wscott/gateway/pkg/client/injection/client"
...
func Get(ctx context.Context) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/n3wscott/gateway/pkg/client/informers/externalversions.SharedInformerFactory from context.")
	}
